...
sealed class HomeAssistantMqttProjectionMapper
{
        ...
        LmsTeslaVehicleState vehicle)
    {
        ...
        [
            ...
            Button(deviceId, "open_sunroof", "Open sunroof", BuildCommandTopic(stateTopic, "sunroof"), "OPEN", enabledByDefault: false, icon: "mdi:car-select"),
            Button(deviceId, "close_sunroof", "Close sunroof", BuildCommandTopic(stateTopic, "sunroof"), "CLOSE", enabledByDefault: false, icon: "mdi:car-select"),
