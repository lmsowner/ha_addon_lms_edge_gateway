...
sealed class HomeAssistantMqttProjectionMapper
{
        ...
        LmsTeslaVehicleState vehicle)
    {
        ...
        [
            ...
            Switch(deviceId, "heated_steering_wheel", "Heated steering wheel", stateTopic, "{{ 'ON' if value_json.heated_steering_wheel else 'OFF' }}", BuildCommandTopic(stateTopic, "heated_steering_wheel"), icon: "mdi:steering"),
            Select(deviceId, "steering_wheel_heat", "Steering wheel heat", stateTopic, "{{ value_json.steering_wheel_heat }}", BuildCommandTopic(stateTopic, "steering_wheel_heat"), SteeringWheelHeatOptions, icon: "mdi:steering"),
            ...
            Select(deviceId, "seat_climate_rear_left", "Rear left seat heater", stateTopic, "{{ value_json.seat_climate_rear_left }}", BuildCommandTopic(stateTopic, "seat_climate_rear_left"), RearSeatHeatOptions, icon: "mdi:car-seat-heater"),
            Select(deviceId, "seat_climate_rear_center", "Rear center seat heater", stateTopic, "{{ value_json.seat_climate_rear_center }}", BuildCommandTopic(stateTopic, "seat_climate_rear_center"), RearSeatHeatOptions, icon: "mdi:car-seat-heater"),
            Select(deviceId, "seat_climate_rear_right", "Rear right seat heater", stateTopic, "{{ value_json.seat_climate_rear_right }}", BuildCommandTopic(stateTopic, "seat_climate_rear_right"), RearSeatHeatOptions, icon: "mdi:car-seat-heater"),
            Select(deviceId, "seat_climate_third_row_left", "Third row left seat heater", stateTopic, "{{ value_json.seat_climate_third_row_left }}", BuildCommandTopic(stateTopic, "seat_climate_third_row_left"), RearSeatHeatOptions, icon: "mdi:car-seat-heater"),
            Select(deviceId, "seat_climate_third_row_right", "Third row right seat heater", stateTopic, "{{ value_json.seat_climate_third_row_right }}", BuildCommandTopic(stateTopic, "seat_climate_third_row_right"), RearSeatHeatOptions, icon: "mdi:car-seat-heater"),
            ...
            Button(deviceId, "open_windows", "Open windows", BuildCommandTopic(stateTopic, "windows"), "OPEN", icon: "mdi:car-door"),
            Button(deviceId, "close_windows", "Close windows", BuildCommandTopic(stateTopic, "windows"), "CLOSE", icon: "mdi:car-door"),
            Cover(deviceId, "frunk", "Frunk", stateTopic, "{{ value_json.frunk_state }}", BuildCommandTopic(stateTopic, "frunk"), "door", icon: "mdi:car"),
            Button(deviceId, "open_frunk_action", "Open frunk", BuildCommandTopic(stateTopic, "frunk"), "OPEN", icon: "mdi:car"),
            Button(deviceId, "close_frunk", "Close frunk", BuildCommandTopic(stateTopic, "frunk"), "CLOSE", icon: "mdi:car"),
            Cover(deviceId, "trunk", "Trunk", stateTopic, "{{ value_json.trunk_state }}", BuildCommandTopic(stateTopic, "trunk"), "door", icon: "mdi:car-back"),
            Button(deviceId, "open_trunk_action", "Open trunk", BuildCommandTopic(stateTopic, "trunk"), "OPEN", icon: "mdi:car-back"),
            Button(deviceId, "close_trunk", "Close trunk", BuildCommandTopic(stateTopic, "trunk"), "CLOSE", icon: "mdi:car-back"),
            Cover(deviceId, "sunroof", "Sunroof", stateTopic, "{{ value_json.sunroof_state }}", BuildCommandTopic(stateTopic, "sunroof"), "window", icon: "mdi:car-select"),
            Button(deviceId, "open_sunroof", "Open sunroof", BuildCommandTopic(stateTopic, "sunroof"), "OPEN", icon: "mdi:car-select"),
            Button(deviceId, "close_sunroof", "Close sunroof", BuildCommandTopic(stateTopic, "sunroof"), "CLOSE", icon: "mdi:car-select"),
            ...
            Button(deviceId, "open_charge_port", "Open charge port", BuildCommandTopic(stateTopic, "charge_port_door"), "OPEN", icon: "mdi:ev-plug-tesla"),
            Button(deviceId, "close_charge_port", "Close charge port", BuildCommandTopic(stateTopic, "charge_port_door"), "CLOSE", icon: "mdi:ev-plug-tesla"),
            ...
            Button(deviceId, "homelink", "Homelink", BuildCommandTopic(stateTopic, "homelink"), icon: "mdi:garage"),
            Button(deviceId, "remote_start", "Remote start", BuildCommandTopic(stateTopic, "remote_start"), icon: "mdi:key-wireless"),
            Button(deviceId, "remote_boombox", "Emissions test", BuildCommandTopic(stateTopic, "remote_boombox"), icon: "mdi:weather-windy"),
            Button(deviceId, "charge_standard", "Charge standard", BuildCommandTopic(stateTopic, "charge_standard"), icon: "mdi:battery-charging"),
            Button(deviceId, "charge_max_range", "Charge max range", BuildCommandTopic(stateTopic, "charge_max_range"), icon: "mdi:battery-charging-100"),
            Button(deviceId, "media_toggle_playback", "Media play pause", BuildCommandTopic(stateTopic, "media_toggle_playback"), icon: "mdi:play-pause"),
            Button(deviceId, "media_next_track", "Media next track", BuildCommandTopic(stateTopic, "media_next_track"), icon: "mdi:skip-next"),
            Button(deviceId, "media_prev_track", "Media previous track", BuildCommandTopic(stateTopic, "media_prev_track"), icon: "mdi:skip-previous"),
            Button(deviceId, "media_next_fav", "Media next favorite", BuildCommandTopic(stateTopic, "media_next_fav"), icon: "mdi:skip-forward"),
            Button(deviceId, "media_prev_fav", "Media previous favorite", BuildCommandTopic(stateTopic, "media_prev_fav"), icon: "mdi:skip-backward"),
            Button(deviceId, "media_volume_up", "Media volume up", BuildCommandTopic(stateTopic, "media_volume_up"), icon: "mdi:volume-plus"),
            Button(deviceId, "media_volume_down", "Media volume down", BuildCommandTopic(stateTopic, "media_volume_down"), icon: "mdi:volume-minus"),
