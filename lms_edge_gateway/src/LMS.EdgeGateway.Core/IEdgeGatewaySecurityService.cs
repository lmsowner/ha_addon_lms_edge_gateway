...
public interface IEdgeGatewaySecurityService
{
    ...
    Task<string> GetTrustedSourceIpsAsync(CancellationToken cancellationToken = default);
    Task SaveTrustedSourceIpsAsync(string trustedSourceIps, CancellationToken cancellationToken = default);
